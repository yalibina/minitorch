...
class Scalar:
    ...
    def chain_rule(self, d_output: Any) -> Iterable[Tuple[Variable, Any]]:
        ...
        Backward processes a function by passing it in a context and \(d\) 
        ...
        last_fn = h.last_fn
        h_grads = last_fn.backward(h.ctx, d_output)
        if not isinstance(h_grads, tuple):
            h_grads = (h_grads,)
    
        pairs = []
        for x, grad in zip(h.inputs, h_grads):
